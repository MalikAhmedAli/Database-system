...
MariaDB [hr]> select city , first_name ,last_name from employees, locations where city  = 'Toronto';
+---------+-------------+-------------+
...
MariaDB [hr]> select count(job_id)<=2,department_name from employees  natural join departments;
+------------------+-----------------+
| count(job_id)<=2 | department_name |
+------------------+-----------------+
|                0 | Marketing       |
+------------------+-----------------+
1 row in set (0.002 sec)
